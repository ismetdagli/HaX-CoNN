...
def build_engine_caffe(model_file, deploy_file, transition, runs_on_gpu, batch, verbose=False):
    with trt.Builder(
        TRT_LOGGER
...
def main(max_workers=4):  # Default to 4, adjust as needed
    ...
    transition = {-1, 10, 24, 38, 53, 67, 81, 95, 109, 124, 139} # transitin cost for googlenet.  -1 is baseline
    batch = 1
    runs_on_gpu = True
